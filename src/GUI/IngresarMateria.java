...
public class IngresarMateria extends JPanel {
	...
	public IngresarMateria(JFrame v,Main l) {
		...
		Image imagen = new ImageIcon(IngresarMateria.class.getResource("/Recs/Universidad_Nacional_del_Sur_sede_Alem3.png")).getImage().getScaledInstance(932, 700, Image.SCALE_SMOOTH);
